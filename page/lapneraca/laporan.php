	...
	<thead>
		...
		<tr>
            ...
            @$thn = $_POST['thn'];
                ...
                $sql20 = $koneksi->query("SELECT * FROM tb_jurnal WHERE tgl_transaksi between '$bln' and '$thn' ");
                ...
                while ($data4=mysqli_fetch_array($sql4)) {
                    @$total_saldo_modal += $data4['kredit']+($total_penjualan)-($total_b_gaji+$total_b_telepon+$total_b_air+$total_b_listrik+$total_b_lain+$total_b_hpp);}
                ?>
